            ...
            <nav class="sidebar-nav left-sidebar-menu-pro">
                <ul class="nav metismenu" id="menu1">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level interface-mini-nb-dp" aria-expanded="false">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level chart-mini-nb-dp" aria-expanded="false">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level form-mini-nb-dp" aria-expanded="false">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level app-mini-nb-dp" aria-expanded="false">
                    ...
                    <li id="removable">
                        ...
                        <ul class="nav nav-second-level page-mini-nb-dp" aria-expanded="false">
