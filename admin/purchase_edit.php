...
<div class="container-fluid">
    ...
    <?php 
        $olddata=array();
        $con['id']=$_GET['id'];
        $result=$mysqli->common_select_single('purchase','*',$con);
        if($result){
            if($result['data']){
                $olddata=$result['data'];
            }
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="post" action="">
                        ...
                        <input type="number" name="supplier_id" class="form-control" id="Supplier" value="<?= $olddata->supplier_id ?>" />
                    ...
                    <?php 
                        if($_POST){
                            ...
                            $_POST['updated_by']=1;
                            $rs=$mysqli->common_update('purchase',$_POST,$con);
                            if($rs){
                                if($rs['data'])
