                    ...
                    <form class="form" method="post" action="">
                                        ...
                                        if($result){
                                            if($result['data']){
                                                ...
                                                foreach($result['data'] as $d){
                                                    $items[$d->id]=$d;
                                    ?>
                                        <option value='<?= json_encode($d) ?>' > <?= $d->product_name ?> </option>
                                    <?php } } } ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-5">
                            <div class="col-12 col-sm-6">
                                <div class="row">
                                    <div class="col-sm-4 offset-2 mt-2 text-right pe-3">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 offset-2 mt-2 text-end pe-3">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="row">
                                    <div class="col-sm-4 offset-4 mt-2 pe-2 text-end">
                                        <label for="" class="form-group"><h6>Subtotal</h6></label> 
                                    </div>
                                    <div class="col-sm-4 mt-2 pe-5 text-end">
...
<script>
    var medicine_data=<?= json_encode($items) ?>;
